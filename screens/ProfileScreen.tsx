...
export default function ProfileScreen() {
  ...
  const cricketStats: CricketStats = useMemo(() => {
    ...
    // Calculate based on profile data (in real app, this would come from match analytics)
    const centuries = Math.floor(profile.totalRuns / 500); // Estimate
    const halfCenturies = Math.floor(profile.totalRuns / 200); // Estimate
