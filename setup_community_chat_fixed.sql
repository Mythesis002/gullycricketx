-- Create Community Chat System for GullyCricketX (FIXED VERSION)
...
-- 3. Create Community Messages Table (FIXED - No community_id needed for single community)
...
-- 15. Insert welcome message (FIXED - No community_id needed)
